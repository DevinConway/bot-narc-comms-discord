...
module.exports.run = async (client, message, args) => {
	...
	if (message.member.hasPermission('ADMINISTRATOR')) {
		...
		const commEmbed1 = new Discord.RichEmbed()
			...
			.setColor('RANDOM')
			.addField('__?kick__', '_This command will kick the user that you stated_\n**Use:** m!kick [user] [reason]')
			.addField('__?ban__', '_This command will ban the user that that you stated_\n**Use:** m!ban [user] [reason]')
			.addField('__?mute__', '_This command will mute the user that you stated_\n**Use:** m!mute [user]')
			.addField('__?unmute__', '_This command will unmute the user that you stated_\n**Use:** m!unmute [user]')
			.addField('__?purge__', 'This command will delete the amount of messages you stated\n**Use:** m!purge [amount]')
			.setFooter('Sent')
			.setTimestamp([new Date().toUTCString()])
